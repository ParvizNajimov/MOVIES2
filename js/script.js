...
let main_box = document.querySelector('.promo__interactive-list')
...
function reload(arr, place) {
    ...
    for (let i of arr) {
        ...
        p.innerHTML = i
        p.innerHTML = (arr.indexOf(i) + 1) + '. ' + i
        main_box.append(box)
        place.append(p, delet)
